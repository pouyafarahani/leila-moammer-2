...
class Migration(migrations.Migration):
    ...
    dependencies = [
        ('MyTeam', '0021_userostadmodel_price5_userostadmodel_price6_and_more'),
    ]
    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('employ', models.ForeignKey(on_delete=django.db.models.deletion.CASCADE, to='MyTeam.userostadmodel')),
            ],
        ),
    ]
